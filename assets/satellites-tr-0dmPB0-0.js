import"./modulepreload-polyfill-B5Qt9EMX.js";const i=[{name:"BİLSAT-1",noradId:27943,cospar:"2003-042E",launch:"2003-09-27T06:12:00Z",launchStr:"27 Eylül 2003 · 06:12 UTC",rocket:"Kosmos-3M",site:"Plesetsk 132/1, Rusya",orbit:"SSO 686 km · 98.2° · 98.5 dk",mass:"130 kg",camera:"ÇOBAN — 12 m PAN, 26 m VNIR",resolution:"12 m",status:"inactive",statusText:"Görev Sona Erdi",color:"#8b949e",highlights:["Türkiye'nin ilk yer gözlem uydusu","SSTL-100 platformu, DMC takımyıldızı üyesi","Batarya hücresi arızası (Ağustos 2006) ile görev tamamlandı"],builder:"SSTL + TÜBİTAK",operator:"TÜBİTAK UZAY",flag:"TR · UK"},{name:"RASAT",noradId:37791,cospar:"2011-044D",launch:"2011-08-17T07:12:00Z",launchStr:"17 Ağustos 2011 · 07:12 UTC",rocket:"Dnepr",site:"Yasny, Rusya",orbit:"SSO ~700 km · 98.1° · 98.4 dk",mass:"93 kg",camera:"7.5 m PAN / 15 m MS",resolution:"7.5 m",status:"inactive",statusText:"İrtibat Kesildi (2022)",color:"#d29922",highlights:["Türkiye'de tasarlanıp üretilen ilk yerli yer gözlem uydusu","3 yıl tasarım ömrüne rağmen 11 yıl çalıştı","BİLGE uçuş bilgisayarı + GEZGİN görüntü işleme modülü"],builder:"TÜBİTAK UZAY",operator:"TÜBİTAK UZAY",flag:"TR"},{name:"GÖKTÜRK-2",noradId:39030,cospar:"2012-073A",launch:"2012-12-18T16:12:52Z",launchStr:"18 Aralık 2012 · 16:12 UTC",rocket:"Long March 2D (CZ-2D)",site:"Jiuquan, Çin",orbit:"SSO 686 km · 98.1° · LTAN 10:30",mass:"~450 kg",camera:"2.5 m PAN / 10 m VNIR / 20 m SWIR",resolution:"2.5 m",status:"active",statusText:"Aktif",color:"#7ee787",highlights:["%80 yerli teknoloji, %100 yerli yazılım","TÜBİTAK UZAY + TUSAŞ ortak geliştirme","12+ yıldır aktif görevde"],builder:"TÜBİTAK UZAY + TUSAŞ",operator:"MSB / Hava Kuvvetleri",flag:"TR"},{name:"GÖKTÜRK-1",noradId:41875,cospar:"2016-073A",launch:"2016-12-05T13:51:44Z",launchStr:"5 Aralık 2016 · 13:51 UTC",rocket:"Vega (VV08)",site:"Kourou, Fransız Guyanası",orbit:"SSO ~695 km · 98.11°",mass:"~1060 kg",camera:"HiRI — 0.50 m PAN / 2.0 m MS",resolution:"0.50 m",status:"active",statusText:"Aktif",color:"#58a6ff",highlights:["Türkiye'nin en yüksek çözünürlüklü (50 cm) aktif uydusu","Proteus platformu, Pleiades optik mirası","Telespazio/Thales Alenia — TAI, ASELSAN, TÜBİTAK, ROKETSAN"],builder:"Telespazio / Thales Alenia",operator:"MSB / Hava Kuvvetleri",flag:"TR · FR · IT"},{name:"GÖKTÜRK-2B",noradId:56178,cospar:"2023-054A",launch:"2023-04-15T06:48:00Z",launchStr:"15 Nisan 2023 · 06:48 UTC",rocket:"Falcon 9 Block 5",site:"Vandenberg SLC-4E, ABD",orbit:"SSO ~680 km",mass:"800 kg",camera:"0.99 m PAN / 3.96 m MSI · 13.9×16.2 km",resolution:"0.99 m",status:"active",statusText:"Aktif",color:"#d2a8ff",highlights:["Türkiye'nin ilk yerli metre-altı gözlem uydusu","TÜBİTAK UZAY tasarım + TUSAŞ Kahramankazan entegrasyon","5 yıl tasarım ömrü"],builder:"TÜBİTAK UZAY",operator:"TÜBİTAK UZAY",flag:"TR"},{name:"İMECE-2",noradId:null,cospar:null,launch:"2027-06-01T00:00:00Z",launchStr:"2027 (planlanıyor)",rocket:"—",site:"—",orbit:"SSO planlanıyor",mass:"—",camera:"~50 cm PAN hedefi",resolution:"0.50 m",status:"planned",statusText:"Planlanan",color:"#f0883e",highlights:["Türkiye'nin 50 cm çözünürlüklü uydusu","İMECE serisinin devamı — yerli tasarım"],builder:"TÜBİTAK UZAY",operator:"TÜBİTAK UZAY",flag:"TR"},{name:"İMECE-3",noradId:null,cospar:null,launch:"2028-06-01T00:00:00Z",launchStr:"2028 (planlanıyor)",rocket:"—",site:"—",orbit:"SSO planlanıyor",mass:"—",camera:"~50 cm PAN hedefi",resolution:"0.50 m",status:"planned",statusText:"Planlanan",color:"#f0883e",highlights:["İMECE serisinin 3. üyesi","Yerli üretim + yüksek çözünürlük devamı"],builder:"TÜBİTAK UZAY",operator:"TÜBİTAK UZAY",flag:"TR"}],b=5e3;let m=0,d=null,v=!0,h=null;function y(){const t=document.getElementById("tr-sat-app");if(!t)return;const e=g();t.innerHTML=`
    ...
    <section class="trs-timeline-wrap">
      ...
      <div class="trs-controls">
        ...
        <div class="trs-idx" id="trs-idx">1 / ${i.length}</div>
      </div>
    </section>
  ...
  `,S(),$(),E(),x(e),M(e),I(),setTimeout(()=>{document.getElementById("trs-track").classList.add("loaded"),setTimeout(()=>{u(0,{animate:!0}),p()},1800)},200)}function S(){const t=document.createElement("div");t.className="trs-starfield",t.setAttribute("aria-hidden","true");for(let e=0;e<180;e++){const a=document.createElement("div"),n=Math.random()<.1?2.5:Math.random()<.3?1.8:1,r=.12+Math.random()*.4,s=Math.min(r+.25+Math.random()*.35,1);a.className="trs-star"+(n>=2?" trs-star-bright":""),a.style.cssText=`left:${(Math.random()*100).toFixed(1)}%;top:${(Math.random()*100).toFixed(1)}%;width:${n}px;height:${n}px;--star-base:${r.toFixed(2)};--star-peak:${s.toFixed(2)};animation-delay:${(Math.random()*5).toFixed(1)}s;animation-duration:${(2+Math.random()*4).toFixed(1)}s`,Math.random()<.08?a.style.background="rgba(120,180,255,0.9)":Math.random()<.04&&(a.style.background="rgba(255,210,140,0.85)"),t.append(a)}document.body.prepend(t)}function $(){const t=()=>{const e=document.createElement("div");e.className="trs-shooting-star",e.style.top=`${5+Math.random()*40}%`,e.style.left=`${Math.random()*65}%`,document.body.append(e),e.addEventListener("animationend",()=>e.remove()),h=setTimeout(t,3e3+Math.random()*8e3)};h=setTimeout(t,1500)}function g(){const t=i.map(n=>new Date(n.launch).getFullYear()),e=Math.min(...t)-1,a=Math.max(...t)+1;return{min:e,max:a}}function f(t,e){return(new Date(t).getFullYear()+new Date(t).getMonth()/12-e.min)/(e.max-e.min)}function E(){const t=document.getElementById("trs-stats"),e=i.filter(l=>l.status!=="planned"),a=i.filter(l=>l.status==="active").length,n=i.filter(l=>l.status==="planned").length,r=new Date(e[0].launch).getFullYear(),s=new Date().getFullYear()-r,o=Math.min(...e.filter(l=>l.status==="active").map(l=>parseFloat(l.resolution)));t.innerHTML=`
    <div class="trs-stat"><div class="trs-stat-val">${e.length}</div><div class="trs-stat-label">Fırlatılan</div></div>
    <div class="trs-stat"><div class="trs-stat-val trs-green">${a}</div><div class="trs-stat-label">Aktif</div></div>
    <div class="trs-stat"><div class="trs-stat-val trs-orange">${n}</div><div class="trs-stat-label">Planlanan</div></div>
    <div class="trs-stat"><div class="trs-stat-val">${s} yıl</div><div class="trs-stat-label">${r} — bugün</div></div>
    <div class="trs-stat"><div class="trs-stat-val trs-blue">${o} m</div><div class="trs-stat-label">En iyi çözünürlük</div></div>
  `}function x(t){const e=document.getElementById("trs-years"),a=t.max-t.min,n=a>20?5:a>10?3:2;for(let r=t.min;r<=t.max;r+=n){const s=(r-t.min)/a,o=document.createElement("div");o.className="trs-year-tick",o.style.left=`${s*100}%`,o.textContent=r,e.append(o)}}function M(t){const e=document.getElementById("trs-nodes");i.forEach((a,n)=>{const r=f(a.launch,t),s=document.createElement("button");s.className=`trs-node trs-node-${a.status}`,s.style.left=`${r*100}%`,s.style.setProperty("--node-color",a.color),s.style.transitionDelay=`${.3+n*.18}s`,s.setAttribute("aria-label",`${a.name} — ${a.launchStr}`),s.innerHTML=`
      <span class="trs-node-dot"></span>
      <span class="trs-node-label">
        <span class="trs-node-year">${new Date(a.launch).getFullYear()}</span>
        <span class="trs-node-name">${a.name}</span>
      </span>
    `,s.addEventListener("click",()=>{c(),u(n,{animate:!0})}),e.append(s)})}function u(t,e={}){m=t;const a=i[t],n=g(),r=f(a.launch,n);document.querySelectorAll(".trs-node").forEach((k,A)=>{k.classList.toggle("active",A===t)});const s=document.getElementById("trs-line-fg"),o=document.getElementById("trs-rocket");s.style.width=`${r*100}%`,s.style.background=`linear-gradient(90deg, #58a6ff, ${a.color})`,o.style.left=`${r*100}%`,o.classList.add("visible");const l=document.getElementById("trs-idx");l&&(l.textContent=`${t+1} / ${i.length}`),B(a,e.animate)}function B(t,e){const a=document.getElementById("trs-detail"),n=t.status==="active";t.status;const r=t.highlights.map(s=>`<li>${s}</li>`).join("");a.style.opacity=e?"0":"1",a.style.setProperty("--detail-color",t.color),a.innerHTML=`
  ...
  `,e&&requestAnimationFrame(()=>{a.style.transition="opacity 0.45s ease, transform 0.45s ease",a.style.transform="translateY(12px)",a.style.opacity="0",requestAnimationFrame(()=>{a.style.transform="translateY(0)",a.style.opacity="1"})})}function I(){document.getElementById("trs-prev").addEventListener("click",()=>{c();const t=(m-1+i.length)%i.length;u(t,{animate:!0})}),document.getElementById("trs-next").addEventListener("click",()=>{c(),u((m+1)%i.length,{animate:!0})}),document.getElementById("trs-play").addEventListener("click",()=>{v?c():p()}),document.addEventListener("keydown",t=>{t.target.tagName==="INPUT"||t.target.tagName==="TEXTAREA"||(t.key==="ArrowLeft"?(c(),u((m-1+i.length)%i.length,{animate:!0})):t.key==="ArrowRight"?(c(),u((m+1)%i.length,{animate:!0})):t.key===" "&&(t.preventDefault(),v?c():p()))})}function p(){v=!0,T(),d&&clearInterval(d),d=setInterval(()=>{u((m+1)%i.length,{animate:!0})},b)}function c(){v=!1,T(),d&&(clearInterval(d),d=null)}function T(){const t=document.getElementById("trs-play"),e=document.getElementById("trs-play-icon");!e||!t||(v?(t.classList.add("playing"),t.setAttribute("aria-label","Oto-oynat durdur"),e.innerHTML='<rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/>'):(t.classList.remove("playing"),t.setAttribute("aria-label","Oto-oynat başlat"),e.innerHTML='<polygon points="6 4 20 12 6 20 6 4"/>'))}window.addEventListener("beforeunload",()=>{d&&clearInterval(d),h&&clearTimeout(h)});document.readyState==="loading"?document.addEventListener("DOMContentLoaded",y):y();
